    ...
    return (
        <div className="container">
            <article className="row single-post mt-5 no-gutters">
                ...
                <h1 className="text-white display-4"><strong>About Me</strong></h1>
                <div>
